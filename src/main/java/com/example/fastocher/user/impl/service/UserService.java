package com.example.fastocher.user.impl.service;

import com.example.fastocher.JWTConfig.impl.CustomUserDetails;
import com.example.fastocher.JWTConfig.impl.JwtTokenUtil;
import com.example.fastocher.JWTConfig.service.JwtUserDetailsService;
import com.example.fastocher.user.api.exceptions.InvalidCredentials;
...
import com.example.fastocher.user.impl.repository.MsgRepository;
...
public class UserService implements IUserService {
    ...
    public RegisterDto registerUser(NewUserDto newUserDto) {
        ...
        jwtRequest.setName(newUserDto.getName());
    ...
    public LoginDto loginUser(JwtRequest authenticationRequest) {
        ...
        final CustomUserDetails customUserDetails = jwtUserDetailsService.loadUserByUsername(authenticationRequest.getName());
